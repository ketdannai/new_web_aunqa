...
<head>
    ...
    <title>บทความวิชาการ | AUN-QA System Dashboard</title>
                ...
                <div class="card shadow-lg p-4 border-0">
                    <div class="card-body">
                        <div class="mb-4 text-start">
                            <button class="btn btn-primary shadow-sm px-4" onclick="openArtModal('add')" style="background-color: #0056b3; font-weight: 600;">
                                <i class="bi bi-plus-circle me-1"></i> เพิ่มบทความใหม่
                            </button>
                        </div>
                                ...
                                <tbody>
                                    <?php if (count($articles) > 0): ?>
                                        <?php foreach ($articles as $art):
                                            ...
                                            $display_authors = implode(", ", $author_names);
                                        ?>
                                            <tr>
                                                <td class="fw-bold text-primary"><?php echo htmlspecialchars($art['art_name']); ?></td>
                                                <td class="text-center small"><?php echo htmlspecialchars($art['art_type']); ?></td>
                                                <td class="author-list"><?php echo $display_authors; ?></td>
                                                <td><?php echo htmlspecialchars($art['art_meet']); ?></td>
                                                <td class="small text-muted"><?php echo htmlspecialchars($art['art_evidence'] ?: '-'); ?></td>
                                                <td class="text-center">
                                                    <?php if ($is_admin || $is_owner): ?>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <button class="btn btn-warning btn-sm shadow-sm" onclick='openArtModal("edit", <?php echo json_encode($art); ?>)'><i class="bi bi-pencil-fill"></i></button>
                                                            <a href="process_article.php?delete=<?php echo $art['art_id']; ?>" class="btn btn-danger btn-sm shadow-sm" onclick="return confirm('ยืนยันการลบข้อมูลนี้?')"><i class="bi bi-trash-fill"></i></a>
                                                        </div>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="6" class="text-center py-4">ไม่พบข้อมูลในระบบ</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title fw-bold" id="artModalTitle">กรอกข้อมูลบทความ</h5>
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label class="form-label fw-bold">ชื่อบทความ (art_name)</label>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="art_type" id="artType" class="form-control" placeholder="เช่น วารสารระดับชาติ" required>
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label fw-bold">หลักฐาน</label>
                                <input type="text" name="art_evidence" id="artEvidence" class="form-control" placeholder="กรอกข้อความหรือ URL">
                            </div>
                        </div>

                        <div class="alert alert-secondary py-2 fw-bold"><i class="bi bi-people-fill me-2"></i> ข้อมูลผู้ทำบทความ</div>

                        <?php for ($i = 1; $i <= 5; $i++): ?>
                            <div class="row g-2 mb-2 align-items-end">
                                <div class="col-md-1 pb-1 text-center"><span class="badge bg-primary">#<?php echo $i; ?></span></div>
                                <div class="col-md-2">
                                    <label class="small text-muted">คำนำหน้า</label>
                                    <input type="text" name="art_title<?php echo $i; ?>" id="art_title<?php echo $i; ?>" class="form-control form-control-sm">
                                </div>
                                <div class="col-md-4">
                                    <label class="small text-muted">ชื่อจริง</label>
                                    <input type="text" name="art_fname<?php echo $i; ?>" id="art_fname<?php echo $i; ?>" class="form-control form-control-sm">
                                </div>
                                <div class="col-md-5">
                                    <label class="small text-muted">นามสกุล</label>
                                    <input type="text" name="art_lname<?php echo $i; ?>" id="art_lname<?php echo $i; ?>" class="form-control form-control-sm">
                                </div>
                            </div>
                        <?php endfor; ?>
